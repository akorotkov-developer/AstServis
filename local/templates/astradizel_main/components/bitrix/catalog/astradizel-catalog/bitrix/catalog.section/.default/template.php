...
<div class="col-sm-12">
    ...
    <div class="table-body">
        ...
        foreach ($arResult['ITEMS'] as $key => $arItem)
        {
            ...
            <div class="item-catalog"id="<? echo $strMainID; ?>">
                <div class="row">
                    <div class="col-sm-2">
                        <div class="table-photo">
                            <a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $imgTitle; ?>"><img src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" alt="<? echo $imgTitle; ?>"></a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="name">
                            <?=$arItem["PROPERTIES"]["APPELLATION"]["VALUE"]?>
                        </div>
                    </div>

                    <div class="col-sm-3">
                        <div class="price" id="<? echo $arItemIDs['PRICE']; ?>">
                            <?echo number_format( $arItem["CATALOG_PRICE_1"], 2, "."," " );?>  <span>руб.</span>
                        </div>
                    </div>
                    ...
                    if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
                     {
                        ...
                        <!-- Наличие товара-->
                        <div class="col-sm-2">
                            <div class="tocart" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>">
                                <a href="javascript:void(0)" id="<? echo $arItemIDs['BUY_LINK']; ?>" rel="nofollow">
                                    <?
