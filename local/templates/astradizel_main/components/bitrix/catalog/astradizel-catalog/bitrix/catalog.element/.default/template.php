...
//Задаем заголовок для детальной страницы товара
/*if ($arResult["PROPERTIES"]["SHORT_NAME"]["VALUE"] != "") {
    $APPLICATION->SetPageProperty("title", $arResult["PROPERTIES"]["SHORT_NAME"]["VALUE"]);
} elseif ($arResult["PROPERTIES"]["APPELLATION"]["VALUE"] != "") {
    $APPLICATION->SetPageProperty("title", $arResult["PROPERTIES"]["APPELLATION"]["VALUE"]);
} else {
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            ...
            <div class="product-images" style="display: none;">
                <div class="product-main-img" id="<? echo $arItemIDs['BIG_IMG_CONT_ID']; ?>">
                    <img id="<? echo $arItemIDs['PICT']; ?>" src="<?=$arResult["PREVIEW_PICTURE"]["SRC"];?>">
                </div>
            </div>
        ...
        <div class="col-sm-7">
            <div class="product-inner">
                ...
                <?} else {?>
                    <h2 class="product-name"><?=$arResult["PROPERTIES"]["APPELLATION"]["VALUE"]?></h2>
                <?}*/?>
                    ...
                    <!-- Цена -->
                        ...
                        ?>
                        <div class="product-inner-price" id="<? echo $arItemIDs['PRICE']; ?>">
                    ...
                    <div class="item_info_section">
                        ...
                        if ($arParams['USE_PRODUCT_QUANTITY'] == 'Y')
                        {
                            if ($arParams['SHOW_BASIS_PRICE'] == 'Y')
                            {
                                ...
                                ?>
                                <p id="<? echo $arItemIDs['BASIS_PRICE'];?>" style="display:none;" class="item_section_name_gray"><? echo GetMessage('CT_BCE_CATALOG_MESS_BASIS_PRICE', $basisPriceInfo); ?></p>
                                <?
                            }
                            ?>
                            ...
                            <form action="" class="cart">
                                <div class="quantity">
                                        ...
                                        <input id="<? echo $arItemIDs['QUANTITY']; ?>" size="4" type="number"class="input-text qty text" title="Qty" name="quantity" min="1" step="1" value="<? echo (isset($arResult['OFFERS']) && !empty($arResult['OFFERS'])
                                            ? 1
                                ...
                                <span class="item_buttons_counter_block" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" style="display: <? echo ($canBuy ? '' : 'none'); ?>;">
                                    ...
                                    {
                                        ?>
                                        <a href="javascript:void(0);" class="add_to_cart_button" id="<? echo $arItemIDs['ADD_BASKET_LINK']; ?>">В корзину</a>
                                        <?
                                    }
                                    ?>
                                </span>
        ...
        ?>
                    ...
                    <div class="product-inner-category">
                        <?if ($arResult["PROPERTIES"]["CREATOR"]["VALUE"]) {?>
                        <p><b>производитель:</b> <?=$arResult["PROPERTIES"]["CREATOR"]["VALUE"];?>
                            <?}?>
                        </p><p><b>код:</b> <?=$arResult["NAME"]?></p>
                        <?if ($arResult["PROPERTIES"]["GARANTY"]["VALUE"]) {?>
                            <p><b>гарантия:</b> <?=$arResult["PROPERTIES"]["GARANTY"]["VALUE"];?></p>
                        <?}?>
                        <?if ($arResult["PROPERTIES"]["PAY"]["VALUE"]) {?>
...
<?if ($arResult["PREVIEW_TEXT"] or $arResult["PROPERTIES"]["TECHNICAL"]["VALUE"]["TEXT"] or $arResult["PROPERTIES"]["KOMPLEKTNOST"]["VALUE"]["TEXT"]) {?>
    <div class="row">
        <div class="col-sm-12">
            <div role="tabpanel">
                ...
                <div class="tab-content">
                    ...
                    <?}?>
                    <?if ($arResult["PREVIEW_TEXT"] and !$arResult["PROPERTIES"]["TECHNICAL"]["VALUE"]["TEXT"]) {?>
