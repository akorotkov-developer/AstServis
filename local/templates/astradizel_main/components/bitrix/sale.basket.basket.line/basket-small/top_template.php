        ...
        <a href="<?= $arParams['PATH_TO_BASKET'] ?>">
            ...
            {?>
                ...
                <? if ($arResult['NUM_PRODUCTS'] > 0 || $arParams['SHOW_EMPTY_VALUES'] == 'Y'){?>
                    <span class="cart-amunt"><?=$arResult['TOTAL_PRICE'] ?></span> <i class="fa fa-shopping-cart"></i>
                <?} else {?>
                    <span class="cart-amunt">0</span> <i class="fa fa-shopping-cart"></i>
                <?}?>
                <span class="product-count"><?=$arResult['NUM_PRODUCTS']?></span>
